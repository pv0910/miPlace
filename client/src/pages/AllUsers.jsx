        ...
        <div className=" flex justify-center items-center flex-col font-mullish py-3">
            ...
            <div className="  w-10/12 mt-4">
                ...
                <div className="flex justify-center items-center flex-col bg-gray-300 rounded-lg">
                    ...
                    <button className="bg-red-600 border-4 p-3  bg-red-500 hover:-translate-y-1 hover:scale-105 hover:bg-red-900 duration-300 text-white my-2" onClick={fetchAllUsers}>{fetchText}</button>
